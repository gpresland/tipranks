...
//api.getMostRecommendedStocks(Benchmark.SNP, Periods.OneMonth).then(function (data) {
//    
//    var i,
//        recommendedStocks = [],
//        stock,
...
//        stock = stocks[i];
//        
//        if (stock.rLastRating.match('')) {
//            recommendedStocks.push({
//                date: stock.rLastRating,
//                price: stock.price,
//                priceTarget: stock.priceTarget,
//                ticker: stock.ticker,
//                change: getUpside(stock.recentStockBehaviour[0], stock.recentStockBehaviour[9]),
//                upside: getUpside(stock.price, stock.priceTarget)
//            });
//        }
//    }
//    
//    recommendedStocks.sort(dynamic('upside'));
//    
//    console.dir(recommendedStocks);
//});
